 ...
 * Case-insensitive substring matching against known keys.
 */
export function resolveCategoryIcon(categoryName: string, categoryColor?: string | null) {
  const normalized = categoryName.toLowerCase()
  const matchKey = Object.keys(CATEGORY_ICONS).find((key) => normalized.includes(key))
  const resolved = matchKey ? CATEGORY_ICONS[matchKey] : DEFAULT_ICON
